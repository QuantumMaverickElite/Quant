...
These six tools audit or smoke-test repository structure. They are maintenance
...
The first five are read-only with respect to source/data and write only their
