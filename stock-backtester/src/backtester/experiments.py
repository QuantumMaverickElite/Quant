...
def build_registry() -> Registry:
    ...
    components = (
        ComponentSpec("component.intelligence.ml_policy.application", "ML policy application", "Capped and thresholded ML-confidence adjustment.", "ACTIVE RESEARCH", "HISTORICAL RESEARCH TOOLING", ("src/backtester/intelligence/ml_policy/application.py",), ("docs/market_intelligence_v4_5.md",), ("command.intelligence.ml_policy.application",), "Not allocator authority and not event-learning authority."),
        ComponentSpec("component.intelligence.ml_policy.validation", "ML policy validation", "Candidate evaluation and block-bootstrap summaries.", "ACTIVE RESEARCH", "HISTORICAL RESEARCH TOOLING", ("src/backtester/intelligence/ml_policy/validation.py",), ("docs/market_intelligence_v4_7.md",), ("command.intelligence.ml_policy.validation",), "Historical v4/v5 research line."),
