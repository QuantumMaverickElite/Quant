...
from .historical_source_collector import HistoricalSourceRecord, parse_ymd
from .provider_policy import annotate_record_policy
...
def write_sec_records(records: list[HistoricalSourceRecord], path: str | Path) -> None:
    ...
    with out.open("w", encoding="utf-8") as f:
        for record in records:
            row = annotate_record_policy(record.to_dict())
