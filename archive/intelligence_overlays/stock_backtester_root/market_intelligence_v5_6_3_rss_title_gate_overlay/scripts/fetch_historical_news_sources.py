...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--allow-rss-body-only", action="store_true", help="Disable strict RSS headline entity gate and allow description/body-only matches to pass relevance.")
...
def fetch_provider_query(provider: str, query: str, args: argparse.Namespace, start, end, request_budget: HttpRequestBudget | None = None):
    ...
    if provider == "rss_yahoo":
        return fetch_yahoo_finance_rss(
            ...
            require_title_entity=not args.allow_rss_body_only,
            **common,
        )
