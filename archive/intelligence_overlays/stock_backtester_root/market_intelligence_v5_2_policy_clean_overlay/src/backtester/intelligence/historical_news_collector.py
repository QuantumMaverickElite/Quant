...
def newsapi_record(query: str, item: dict) -> HistoricalSourceRecord:
    ...
    return HistoricalSourceRecord(
        ...
        matched_terms=matched,
        relevance_score=relevance,
        raw=policy_raw("newsapi_everything", item),
    )
...
def fetch_alpha_vantage_news(
    *,
    ...
    client = JsonApiClient(sleep_seconds=sleep_seconds, max_retries=max_retries, backoff_seconds=backoff_seconds, timeout_seconds=timeout_seconds)
