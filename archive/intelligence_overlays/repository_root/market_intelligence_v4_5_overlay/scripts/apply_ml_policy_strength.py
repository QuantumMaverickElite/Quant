...
def apply_policy(df: pd.DataFrame, *, base_col: str, ml_col: str, output_col: str, strength: float, max_abs_delta: float) -> pd.DataFrame:
    out = df.copy()
    ...
    out[output_col] = base + capped_delta
    return out
